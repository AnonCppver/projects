...
template <int SIZE>
const char *prj::detail::FixedBuffer<SIZE>::debugString()
{
    *cur_ = '\0';
    return data_;
}
...
template <int SIZE>
void prj::detail::FixedBuffer<SIZE>::cookieStart()
{
}

template <int SIZE>
void prj::detail::FixedBuffer<SIZE>::cookieEnd()
{
}

void prj::LogStream::staticCheck()
{
...
template <typename T>
void prj::LogStream::formatInteger(T v)
{
    if (buffer_.avail() >= kMaxNumericSize)
    {
        size_t len = prj::detail::convert(buffer_.current(), v);
        buffer_.add(len);
    }
}

prj::LogStream &prj::LogStream::operator<<(short v)
{
    *this << static_cast<int>(v);
    return *this;
}

prj::LogStream &prj::LogStream::operator<<(unsigned short v)
{
    *this << static_cast<unsigned int>(v);
    return *this;
}

prj::LogStream &prj::LogStream::operator<<(int v)
{
    formatInteger(v);
    return *this;
}

prj::LogStream &prj::LogStream::operator<<(unsigned int v)
{
    formatInteger(v);
    return *this;
}

prj::LogStream &prj::LogStream::operator<<(long v)
{
    formatInteger(v);
    return *this;
}

prj::LogStream &prj::LogStream::operator<<(unsigned long v)
{
    formatInteger(v);
    return *this;
}

prj::LogStream &prj::LogStream::operator<<(long long v)
{
    formatInteger(v);
    return *this;
}

prj::LogStream &prj::LogStream::operator<<(unsigned long long v)
{
    formatInteger(v);
    return *this;
}

prj::LogStream &prj::LogStream::operator<<(const void *p)
{
    ...
    if (buffer_.avail() >= kMaxNumericSize)
    {
        ...
        buf[0] = '0';
        buf[1] = 'x';
        size_t len = prj::detail::convertHex(buf + 2, v);
        buffer_.add(len + 2);
    }
    return *this;
}
...
prj::LogStream &prj::LogStream::operator<<(double v)
{
    if (buffer_.avail() >= kMaxNumericSize)
    {
        /* int len = snprintf(buffer_.current(), kMaxNumericSize, "%.12g", v);
        buffer_.add(len); */
        auto r=std::to_chars(buffer_.current(), (char *)buffer_.end(), v);
        if (r.ec == std::errc())
        {
            buffer_.add(static_cast<int>(r.ptr - buffer_.current()));
        }
