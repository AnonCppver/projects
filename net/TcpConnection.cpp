...
void leef::net::defaultConnectionCallback(const TcpConnectionPtr& conn)
{
...
void leef::net::defaultMessageCallback(const TcpConnectionPtr&,
                                        Buffer* buf,
                                        Timestamp)
{
  buf->retrieveAll();
...
{ 
  if (state_ == kConnected || state_ == kDisconnecting)
  {
    ...
    loop_->runAfter(seconds, [weakConn]() {
